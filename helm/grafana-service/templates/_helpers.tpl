...
*/}}
{{- define "grafana-service.fullname" -}}
...
Common labels
*/}}
{{- define "grafana-service.labels" -}}
helm.sh/chart: {{ include "grafana-service.chart" . }}
{{ include "grafana-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "grafana-service.selectorLabels" -}}
app.kubernetes.io/name: {{ include "grafana-service.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
app: realtime-grafana
{{- end }}
...
*/}}
{{- define "grafana-service.fixRouting" -}}
- name: fix-routing
...
*/}}
{{- define "grafana-service.consulTagPatcher" -}}
{{- $nadName := .nadName -}}
{{- $port    := .port    -}}
{{- $ctx     := .ctx     -}}
