...
Common labels
*/}}
{{- define "admin-app-ui.labels" -}}
helm.sh/chart: {{ include "admin-app-ui.chart" . }}
{{ include "admin-app-ui.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "admin-app-ui.selectorLabels" -}}
app.kubernetes.io/name: {{ include "admin-app-ui.name" . }}
