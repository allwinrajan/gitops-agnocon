...
Common labels
*/}}
{{- define "acd-service.labels" -}}
helm.sh/chart: {{ include "acd-service.chart" . }}
{{ include "acd-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "acd-service.selectorLabels" -}}
app.kubernetes.io/name: {{ include "acd-service.name" . }}
...
PVC name
*/}}
{{- define "acd-service.pvcName" -}}
{{- include "acd-service.fullname" . }}-logs
{{- end }}
